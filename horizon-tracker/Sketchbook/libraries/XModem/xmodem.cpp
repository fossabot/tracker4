...
// Serial.println("int ReceiveXmodem(XMODEM *pX)");
...
//#endif // STAND_ALONE
    ...
    while(ecount < TOTAL_ERROR_COUNT && ec2 < ACK_ERROR_COUNT) // ** loop to get SOH or EOT character **
    {
        ...
        Serial.print("while(ecount < TOTAL_ERROR_COUNT && ec2 < ACK_ERROR_COUNT) -> ecount = ");
        Serial.print(ecount);
        Serial.print(", ec2 = ");
        Serial.println(ec2);
#endif
...
//  If filesize& <> 0 Then Form2!Label1.FloodPercent = 100 * filepos& / filesize&
      ...
      Serial.println(100 * filepos / filesize);
    #endif
